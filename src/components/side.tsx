    ...
    <>
      <div className="w-0 hidden md:w-[120px] md:block">
        <div className="w-full p-1 flex flex-col h-screen">
          ...
          <div className="flex-1 overflow-x-hidden overflow-y-auto h-0 rounded-box bg-base-200">
            <div>
              <List {...props} />
            </div>
          </div>
      ...
      <div className={`${props.site?.url ? 'hidden' : 'block'} md:hidden`}>
        <div className="w-full p-4 mt-5 mb-5">
          <h1 className="p-2">Click on the website list below and refresh the page to return.</h1>
          <List {...props} />
        </div>
      </div>
    </>
